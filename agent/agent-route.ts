...
//     const contextData = searchResults.matches.map((match: any) => match.metadata.text).join("\n");

//     console.log("contextData==>" + contextData);
//     const retrieverTool = createRetrieverTool(contextData as any, {
//       name: "context",
...
//     // Prompt Template
//     const prompt = ChatPromptTemplate.fromMessages([("system", "You are a helpful assistant."), new MessagesPlaceholder("history"), ("human", "{input}"), new MessagesPlaceholder("agent_scratchpad")]);
